...
THING_NAME = "Testdata"
TOPIC = "newpol"  
CERTIFICATE_PATH = r"C:\Users\Asus\Downloads\aws-final\python\python\FoodData\certificate.pem.crt"
PRIVATE_KEY_PATH = r"C:\Users\Asus\Downloads\aws-final\python\python\FoodData\private.pem.key"
ROOT_CA_PATH = r"C:\Users\Asus\Downloads\aws-final\python\python\FoodData\AmazonRootCA1.pem"
...
def publish_data():
    while True:
        df = pd.read_excel(r"C:\Users\Asus\Downloads\aws-final\python\python\FoodData\FoodData.xlsx")  # Read Excel file
